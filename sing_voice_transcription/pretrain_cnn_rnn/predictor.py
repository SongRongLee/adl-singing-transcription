...
class RNNPredictor:
    def __init__(self, pretrain_cnn_path_list, model_path=None):
        """
        Params:
        model_path: Optional pretrained model file
        """
        # Initialize model
        self.model = RNN(pretrain_cnn_path_list=pretrain_cnn_path_list).cuda()
    ...
    def fit(self, train_dataset_path, valid_dataset_path, model_dir, **training_args):
        ...
        for epoch in range(1, self.epoch + 1):
            ...
            for batch_idx, batch in enumerate(self.train_loader):
                ...
                pitch_logits = pitch_logits.permute(0, 2, 1)
    ...
    def predict(self, test_dataset, chunk_size=150, discard_frame=False):
